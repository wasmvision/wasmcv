      ...
      impl Mat {
        ...
        pub fn new(id: u32,) -> Self{
          unsafe {
            ...
            let ret = unsafe { wit_import0(_rt::as_i32(&id)) };
            unsafe { Mat::from_handle(ret as u32) }
          }
        }
      }
      impl Mat {
        ...
        pub fn new_with_size(cols: u32,rows: u32,mattype: Mattype,) -> Mat{
          unsafe {
            ...
            let ret = unsafe { wit_import0(_rt::as_i32(&cols), _rt::as_i32(&rows), mattype.clone() as i32) };
            unsafe { Mat::from_handle(ret as u32) }
          }
        }
      }
      ...
      impl Mat {
        ...
        pub fn region(&self,rect: Rect,) -> Mat{
          unsafe {
            ...
            let ret = unsafe { wit_import3((self).handle() as i32, _rt::as_i32(x1), _rt::as_i32(y1), _rt::as_i32(x2), _rt::as_i32(y2)) };
            unsafe { Mat::from_handle(ret as u32) }
          }
        }
      }
      impl Mat {
        ...
        pub fn copy_to(&self,dst: &Mat,) -> (){
          unsafe {
            ...
            unsafe { wit_import0((self).handle() as i32, (dst).handle() as i32) };
          }
        }
      }
      impl Mat {
      ...
      impl Mat {
        ...
        pub fn get_float_at(&self,row: u32,col: u32,) -> f32{
          unsafe {
            ...
            let ret = unsafe { wit_import0((self).handle() as i32, _rt::as_i32(&row), _rt::as_i32(&col)) };
            ret
          }
        }
      }
      impl Mat {
        ...
        pub fn set_float_at(&self,row: u32,col: u32,val: f32,) -> (){
          unsafe {
            ...
            unsafe { wit_import0((self).handle() as i32, _rt::as_i32(&row), _rt::as_i32(&col), _rt::as_f32(&val)) };
          }
        }
      }
      impl Mat {
      ...
      impl Mat {
        ...
        pub fn set_uchar_at(&self,row: u32,col: u32,val: u8,) -> (){
          unsafe {
            ...
            unsafe { wit_import0((self).handle() as i32, _rt::as_i32(&row), _rt::as_i32(&col), _rt::as_i32(&val)) };
          }
        }
      }
      impl Mat {
      ...
      impl Mat {
        ...
        pub fn get_float_at3(&self,x: u32,y: u32,z: u32,) -> f32{
          unsafe {
            ...
            let ret = unsafe { wit_import0((self).handle() as i32, _rt::as_i32(&x), _rt::as_i32(&y), _rt::as_i32(&z)) };
            ret
          }
        }
      }
      impl Mat {
        ...
        pub fn set_float_at3(&self,x: u32,y: u32,z: u32,val: f32,) -> (){
          unsafe {
            ...
            unsafe { wit_import0((self).handle() as i32, _rt::as_i32(&x), _rt::as_i32(&y), _rt::as_i32(&z), _rt::as_f32(&val)) };
          }
        }
      }
      impl Mat {
      ...
      impl Mat {
        ...
        pub fn set_uchar_at3(&self,x: u32,y: u32,z: u32,val: u8,) -> (){
          unsafe {
            ...
            unsafe { wit_import0((self).handle() as i32, _rt::as_i32(&x), _rt::as_i32(&y), _rt::as_i32(&z), _rt::as_i32(&val)) };
          }
        }
      }
      impl Mat {
      ...
      impl Mat {
        ...
        pub fn get_vecb_at(&self,row: u32,col: u32,) -> _rt::Vec::<u8>{
          unsafe {
            ...
            unsafe { wit_import1((self).handle() as i32, _rt::as_i32(&row), _rt::as_i32(&col), ptr0) };
            let l2 = *ptr0.add(0).cast::<*mut u8>();
            let l3 = *ptr0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
            let len4 = l3;
            let result5 = _rt::Vec::from_raw_parts(l2.cast(), len4, len4);
      ...
      impl Mat {
        ...
        pub fn reshape(&self,channels: u32,rows: u32,) -> Result<Mat,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, _rt::as_i32(&channels), _rt::as_i32(&rows), ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
      ...
      impl Mat {
        ...
        pub fn row_range(&self,start: u32,end: u32,) -> Result<Mat,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, _rt::as_i32(&start), _rt::as_i32(&end), ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
      ...
      impl Mat {
        ...
        pub fn col(&self,col: u32,) -> Result<Mat,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, _rt::as_i32(&col), ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
      ...
      impl Mat {
        ...
        pub fn row(&self,row: u32,) -> Result<Mat,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, _rt::as_i32(&row), ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
            ...
            let result8 = match l3 {
              0 => {
                let e = {
                  ...
                  unsafe { Mat::from_handle(l4 as u32) }
                };
                Ok(e)
              }
              1 => {
      ...
      impl Mat {
        ...
        pub fn zeros(cols: u32,rows: u32,mattype: Mattype,) -> Result<Mat,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1(_rt::as_i32(&cols), _rt::as_i32(&rows), mattype.clone() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
    ...
    pub mod cv {
      ...
      pub fn arrowed_line(img: &Mat,point1: Point,point2: Point,c: Rgba,thickness: u8,) -> Result<(),ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import4((img).handle() as i32, _rt::as_i32(x0), _rt::as_i32(y0), _rt::as_i32(x1), _rt::as_i32(y1), _rt::as_i32(r2), _rt::as_i32(g2), _rt::as_i32(b2), _rt::as_i32(a2), _rt::as_i32(&thickness), ptr3) };
      ...
      pub fn rectangle(img: &Mat,r: Rect,c: Rgba,thickness: u8,) -> Result<(),ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import5((img).handle() as i32, _rt::as_i32(x1), _rt::as_i32(y1), _rt::as_i32(x2), _rt::as_i32(y2), _rt::as_i32(r3), _rt::as_i32(g3), _rt::as_i32(b3), _rt::as_i32(a3), _rt::as_i32(&thickness), ptr4) };
      ...
      pub fn circle(img: &Mat,center: Point,radius: u32,c: Rgba,thickness: u8,) -> Result<(),ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import3((img).handle() as i32, _rt::as_i32(x0), _rt::as_i32(y0), _rt::as_i32(&radius), _rt::as_i32(r1), _rt::as_i32(g1), _rt::as_i32(b1), _rt::as_i32(a1), _rt::as_i32(&thickness), ptr2) };
      ...
      pub fn put_text(img: &Mat,text: &str,org: Point,font_face: HersheyFontType,font_scale: f64,c: Rgba,thickness: i32,) -> Result<(),ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import4((img).handle() as i32, ptr0.cast_mut(), len0, _rt::as_i32(x1), _rt::as_i32(y1), font_face.clone() as i32, _rt::as_f64(&font_scale), _rt::as_i32(r2), _rt::as_i32(g2), _rt::as_i32(b2), _rt::as_i32(a2), _rt::as_i32(&thickness), ptr3) };
          let l5 = i32::from(*ptr3.add(0).cast::<u8>());
          let result9 = match l5 {
            0 => {
              let e = ();
      ...
      pub fn adaptive_threshold(src: Mat,max_value: f32,adaptive_type: AdaptiveThresholdType,threshold_type: ThresholdType,block_size: u32,c: f32,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import1((&src).take_handle() as i32, _rt::as_f32(&max_value), adaptive_type.clone() as i32, threshold_type.clone() as i32, _rt::as_i32(&block_size), _rt::as_f32(&c), ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn blur(src: Mat,k_size: Size,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import2((&src).take_handle() as i32, _rt::as_i32(x0), _rt::as_i32(y0), ptr1) };
          let l3 = i32::from(*ptr1.add(0).cast::<u8>());
          let result8 = match l3 {
            0 => {
              let e = {
                ...
                unsafe { super::super::super::wasm::cv::mat::Mat::from_handle(l4 as u32) }
              };
              Ok(e)
            }
            1 => {
      ...
      pub fn box_filter(src: Mat,depth: u32,k_size: Size,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import2((&src).take_handle() as i32, _rt::as_i32(&depth), _rt::as_i32(x0), _rt::as_i32(y0), ptr1) };
          let l3 = i32::from(*ptr1.add(0).cast::<u8>());
          let result8 = match l3 {
            0 => {
              let e = {
      ...
      pub fn canny(src: Mat,threshold1: f32,threshold2: f32,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import1((&src).take_handle() as i32, _rt::as_f32(&threshold1), _rt::as_f32(&threshold2), ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn cvt_color(src: Mat,code: ColorCoversionType,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1((&src).take_handle() as i32, code.clone() as i32, ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn dilate(src: Mat,kernel: Mat,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1((&src).take_handle() as i32, (&kernel).take_handle() as i32, ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn equalize_hist(src: Mat,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1((&src).take_handle() as i32, ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn gaussian_blur(src: Mat,size: Size,sigma_x: f32,sigma_y: f32,border: BorderType,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import2((&src).take_handle() as i32, _rt::as_i32(x0), _rt::as_i32(y0), _rt::as_f32(&sigma_x), _rt::as_f32(&sigma_y), border.clone() as i32, ptr1) };
          let l3 = i32::from(*ptr1.add(0).cast::<u8>());
          let result8 = match l3 {
            0 => {
              let e = {
      ...
      pub fn get_structuring_element(shape: MorphShape,size: Size,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import2(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import2(shape.clone() as i32, _rt::as_i32(x0), _rt::as_i32(y0), ptr1) };
          let l3 = i32::from(*ptr1.add(0).cast::<u8>());
          let result8 = match l3 {
            0 => {
              let e = {
      ...
      pub fn hough_lines(src: Mat,rho: f64,theta: f64,threshold: i32,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import1((&src).take_handle() as i32, _rt::as_f64(&rho), _rt::as_f64(&theta), _rt::as_i32(&threshold), ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn resize(src: Mat,size: Size,fx: f32,fy: f32,interp: InterpolationType,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import2(_: i32, _: i32, _: i32, _: f32, _: f32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import2((&src).take_handle() as i32, _rt::as_i32(x0), _rt::as_i32(y0), _rt::as_f32(&fx), _rt::as_f32(&fy), interp.clone() as i32, ptr1) };
          let l3 = i32::from(*ptr1.add(0).cast::<u8>());
          let result8 = match l3 {
            0 => {
              let e = {
      ...
      pub fn threshold(src: Mat,thresh: f32,max_value: f32,threshold_type: ThresholdType,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import1((&src).take_handle() as i32, _rt::as_f32(&thresh), _rt::as_f32(&max_value), threshold_type.clone() as i32, ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn transpose_nd(src: Mat,order: &[i32],) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import2((&src).take_handle() as i32, ptr0.cast_mut(), len0, ptr1) };
          let l3 = i32::from(*ptr1.add(0).cast::<u8>());
          let result8 = match l3 {
            0 => {
              let e = {
      ...
      pub fn estimate_affine2d(frm: Mat,to: Mat,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1((&frm).take_handle() as i32, (&to).take_handle() as i32, ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn warp_affine(src: Mat,m: Mat,size: Size,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import2(_: i32, _: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import2((&src).take_handle() as i32, (&m).take_handle() as i32, _rt::as_i32(x0), _rt::as_i32(y0), ptr1) };
          let l3 = i32::from(*ptr1.add(0).cast::<u8>());
          let result8 = match l3 {
            0 => {
              let e = {
      ...
      pub fn get_rotation_matrix2d(center: Point,angle: f64,scale: f64,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import2(_rt::as_i32(x0), _rt::as_i32(y0), _rt::as_f64(&angle), _rt::as_f64(&scale), ptr1) };
          let l3 = i32::from(*ptr1.add(0).cast::<u8>());
          let result8 = match l3 {
            0 => {
              let e = {
      ...
      pub fn add(src1: Mat,src2: Mat,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1((&src1).take_handle() as i32, (&src2).take_handle() as i32, ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn add_weighted(src1: Mat,alpha: f64,src2: Mat,beta: f64,gamma: f64,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import1((&src1).take_handle() as i32, _rt::as_f64(&alpha), (&src2).take_handle() as i32, _rt::as_f64(&beta), _rt::as_f64(&gamma), ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn lut(src: Mat,wblut: Mat,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1((&src).take_handle() as i32, (&wblut).take_handle() as i32, ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
      ...
      pub fn reduce_arg_max(src: Mat,axis: u32,last_index: bool,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
          unsafe { wit_import1((&src).take_handle() as i32, _rt::as_i32(&axis), match &last_index { true => 1, false => 0 }, ptr0) };
          let l2 = i32::from(*ptr0.add(0).cast::<u8>());
          let result7 = match l2 {
            0 => {
              let e = {
    ...
    pub mod dnn {
      ...
      impl Layer {
        ...
        pub fn new() -> Self{
          unsafe {
            ...
            unsafe { Layer::from_handle(ret as u32) }
          }
        }
      }
      impl Layer {
            ...
            let result9 = match l4 {
              0 => {
                let e = {
                  ...
                  unsafe { Net::from_handle(l5 as u32) }
                };
                Ok(e)
              }
              1 => {
            ...
            let result8 = match l3 {
              0 => {
                let e = {
                  ...
                  unsafe { Net::from_handle(l4 as u32) }
                };
                Ok(e)
              }
              1 => {
      ...
      impl Net {
        ...
        pub fn set_input(&self,input: Mat,name: &str,) -> Result<(),ErrorResult>{
          unsafe {
            ...
            unsafe { wit_import2((self).handle() as i32, (&input).take_handle() as i32, ptr0.cast_mut(), len0, ptr1) };
            let l3 = i32::from(*ptr1.add(0).cast::<u8>());
      ...
      impl Net {
        ...
        pub fn forward_layers(&self,output_names: &[_rt::String],) -> Result<_rt::Vec::<Mat>,ErrorResult>{
          unsafe {
            ...
            unsafe { wit_import3((self).handle() as i32, result1, len1, ptr2) };
            let l4 = i32::from(*ptr2.add(0).cast::<u8>());
                ...
                let e = {
                  ...
                  for i in 0..len8 {
                    ...
                    let e8 = {
                      ...
                      unsafe { super::super::super::wasm::cv::mat::Mat::from_handle(l7 as u32) }
                    };
                    result8.push(e8);
                  }
      ...
      impl Net {
        ...
        pub fn get_layer(&self,id: u32,) -> Result<Layer,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, _rt::as_i32(&id), ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
                  ...
                  unsafe { Layer::from_handle(l3 as u32) }
                };
                Ok(e)
              }
              1 => {
      ...
      pub fn blob_from_image(image: Mat,scale_factor: f32,size: Size,mean: Scalar,swap_rb: bool,crop: bool,) -> Result<Mat,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import3((&image).take_handle() as i32, _rt::as_f32(&scale_factor), _rt::as_i32(x0), _rt::as_i32(y0), _rt::as_f32(val11), _rt::as_f32(val21), _rt::as_f32(val31), _rt::as_f32(val41), match &swap_rb { true => 1, false => 0 }, match &crop { true => 1, false => 0 }, ptr2) };
          let l4 = i32::from(*ptr2.add(0).cast::<u8>());
          let result9 = match l4 {
            0 => {
              let e = {
                ...
                unsafe { super::super::super::wasm::cv::mat::Mat::from_handle(l5 as u32) }
              };
              Ok(e)
            }
            1 => {
      ...
      pub fn nms_boxes(bboxes: &[Rect],scores: &[f32],score_threshold: f32,nms_threshold: f32,) -> Result<_rt::Vec::<u32>,ErrorResult>{
        unsafe {
          ...
          unsafe { wit_import3(ptr0.cast_mut(), len0, ptr1.cast_mut(), len1, _rt::as_f32(&score_threshold), _rt::as_f32(&nms_threshold), ptr2) };
          let l4 = i32::from(*ptr2.add(0).cast::<u8>());
      ...
      impl CascadeClassifier {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe { CascadeClassifier::from_handle(ret as u32) }
          }
        }
      }
      impl CascadeClassifier {
      ...
      impl CascadeClassifier {
        ...
        pub fn detect_multi_scale(&self,image: Mat,) -> Result<_rt::Vec::<Rect>,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&image).take_handle() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result9 = match l2 {
              0 => {
                let e = {
      ...
      impl CascadeClassifier {
        ...
        pub fn detect_multi_scale_with_params(&self,image: Mat,scale: f64,min_neighbors: u32,flags: u32,min_size: Size,max_size: Size,) -> Result<_rt::Vec::<Rect>,ErrorResult>{
          unsafe {
            ...
            unsafe { wit_import3((self).handle() as i32, (&image).take_handle() as i32, _rt::as_f64(&scale), _rt::as_i32(&min_neighbors), _rt::as_i32(&flags), _rt::as_i32(x0), _rt::as_i32(y0), _rt::as_i32(x1), _rt::as_i32(y1), ptr2) };
            let l4 = i32::from(*ptr2.add(0).cast::<u8>());
            let result11 = match l4 {
              0 => {
                let e = {
      ...
      impl HogDescriptor {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe extern "C" fn wit_import1(_: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import1(ptr0.cast_mut(), len0) };
            unsafe { HogDescriptor::from_handle(ret as u32) }
          }
        }
      }
      impl HogDescriptor {
      ...
      impl HogDescriptor {
        ...
        pub fn detect_multi_scale_with_params(&self,image: Mat,hit_threshold: f64,win_stride: Size,padding: Size,scale: f64,final_threshold: f64,use_meanshift_grouping: bool,) -> Result<_rt::Vec::<Rect>,ErrorResult>{
          unsafe {
            ...
            unsafe { wit_import3((self).handle() as i32, (&image).take_handle() as i32, _rt::as_f64(&hit_threshold), _rt::as_i32(x0), _rt::as_i32(y0), _rt::as_i32(x1), _rt::as_i32(y1), _rt::as_f64(&scale), _rt::as_f64(&final_threshold), match &use_meanshift_grouping { true => 1, false => 0 }, ptr2) };
            let l4 = i32::from(*ptr2.add(0).cast::<u8>());
            let result11 = match l4 {
              0 => {
                let e = {
      ...
      impl FaceDetectorYn {
        ...
        pub fn new(model: &str,config: &str,input_size: Size,) -> Self{
          unsafe {
            ...
            let ret = unsafe { wit_import3(ptr0.cast_mut(), len0, ptr1.cast_mut(), len1, _rt::as_i32(x2), _rt::as_i32(y2)) };
            unsafe { FaceDetectorYn::from_handle(ret as u32) }
          }
        }
      }
      impl FaceDetectorYn {
        ...
        pub fn new_with_params(model: &str,config: &str,input_size: Size,score_threshold: f32,nms_threshold: f32,top_k: u32,backend_id: u32,target_id: u32,) -> FaceDetectorYn{
          unsafe {
            ...
            let ret = unsafe { wit_import3(ptr0.cast_mut(), len0, ptr1.cast_mut(), len1, _rt::as_i32(x2), _rt::as_i32(y2), _rt::as_f32(&score_threshold), _rt::as_f32(&nms_threshold), _rt::as_i32(&top_k), _rt::as_i32(&backend_id), _rt::as_i32(&target_id)) };
            unsafe { FaceDetectorYn::from_handle(ret as u32) }
          }
        }
      }
      ...
      impl FaceDetectorYn {
        ...
        pub fn detect(&self,input: Mat,) -> Result<Mat,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&input).take_handle() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
      ...
      impl FaceDetectorYn {
        ...
        pub fn set_input_size(&self,size: Size,) -> (){
          unsafe {
            ...
            unsafe { wit_import1((self).handle() as i32, _rt::as_i32(x0), _rt::as_i32(y0)) };
          }
        }
      }
      impl FaceDetectorYn {
        ...
        pub fn set_nms_threshold(&self,threshold: f32,) -> (){
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import0(_: i32, _: f32, ){ unreachable!() }
            unsafe { wit_import0((self).handle() as i32, _rt::as_f32(&threshold)) };
          }
        }
      }
      impl FaceDetectorYn {
      ...
      impl FaceDetectorYn {
        ...
        pub fn set_topk(&self,topk: u32,) -> (){
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import0(_: i32, _: i32, ){ unreachable!() }
            unsafe { wit_import0((self).handle() as i32, _rt::as_i32(&topk)) };
          }
        }
      }
      impl FaceRecognizerSf {
        ...
        pub fn new(model: &str,config: &str,) -> Self{
          unsafe {
            ...
            unsafe { FaceRecognizerSf::from_handle(ret as u32) }
          }
        }
      }
      impl FaceRecognizerSf {
        ...
        pub fn new_with_params(model: &str,config: &str,backend_id: u32,target_id: u32,) -> FaceRecognizerSf{
          unsafe {
            ...
            let ret = unsafe { wit_import2(ptr0.cast_mut(), len0, ptr1.cast_mut(), len1, _rt::as_i32(&backend_id), _rt::as_i32(&target_id)) };
            unsafe { FaceRecognizerSf::from_handle(ret as u32) }
          }
        }
      }
      ...
      impl FaceRecognizerSf {
        ...
        pub fn align_crop(&self,src: Mat,face_box: Mat,) -> Result<Mat,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&src).take_handle() as i32, (&face_box).take_handle() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
      ...
      impl FaceRecognizerSf {
        ...
        pub fn feature(&self,aligned: Mat,) -> Result<Mat,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&aligned).take_handle() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
      ...
      impl FaceRecognizerSf {
        ...
        pub fn match_(&self,face1: Mat,face2: Mat,) -> Result<f32,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&face1).take_handle() as i32, (&face2).take_handle() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
      ...
      impl FaceRecognizerSf {
        ...
        pub fn match_with_params(&self,face1: Mat,face2: Mat,distance: FaceDistanceType,) -> Result<f32,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&face1).take_handle() as i32, (&face2).take_handle() as i32, distance.clone() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
      ...
      impl AkazeDetector {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe extern "C" fn wit_import1(_: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import1(ptr0.cast_mut(), len0) };
            unsafe { AkazeDetector::from_handle(ret as u32) }
          }
        }
      }
      impl AkazeDetector {
      ...
      impl AkazeDetector {
        ...
        pub fn detect(&self,src: Mat,) -> Result<_rt::Vec::<KeyPoint>,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&src).take_handle() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result9 = match l2 {
              0 => {
                let e = {
      ...
      impl AkazeDetector {
        ...
        pub fn compute(&self,src: Mat,mask: Mat,kps: &[KeyPoint],) -> Result<DetectorResult,ErrorResult>{
          unsafe {
            ...
            unsafe { wit_import2((self).handle() as i32, (&src).take_handle() as i32, (&mask).take_handle() as i32, ptr0.cast_mut(), len0, ptr1) };
            let l3 = i32::from(*ptr1.add(0).cast::<u8>());
              ...
              0 => {
                let e = {
                  ...
                  DetectorResult{
                    ...
                    desc: unsafe { super::super::super::wasm::cv::mat::Mat::from_handle(l7 as u32) },
                  }
                };
                Ok(e)
              }
      ...
      impl AkazeDetector {
        ...
        pub fn detect_and_compute(&self,src: Mat,mask: Mat,) -> Result<DetectorResult,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&src).take_handle() as i32, (&mask).take_handle() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
              ...
              0 => {
                let e = {
                  ...
                  DetectorResult{
                    ...
                    desc: unsafe { super::super::super::wasm::cv::mat::Mat::from_handle(l6 as u32) },
                  }
                };
                Ok(e)
              }
      ...
      impl BriskDetector {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe extern "C" fn wit_import1(_: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import1(ptr0.cast_mut(), len0) };
            unsafe { BriskDetector::from_handle(ret as u32) }
          }
        }
      }
      impl BriskDetector {
      ...
      impl KazeDetector {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe extern "C" fn wit_import1(_: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import1(ptr0.cast_mut(), len0) };
            unsafe { KazeDetector::from_handle(ret as u32) }
          }
        }
      }
      impl KazeDetector {
      ...
      impl OrbDetector {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe extern "C" fn wit_import1(_: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import1(ptr0.cast_mut(), len0) };
            unsafe { OrbDetector::from_handle(ret as u32) }
          }
        }
      }
      impl OrbDetector {
        ...
        pub fn new_with_params(features: u32,scale: f32,levels: u32,edge_threshold: u32,first: u32,wtak: u32,score_type: OrbScoreType,patch_size: u32,fast_threshold: u32,) -> OrbDetector{
          unsafe {
            ...
            let ret = unsafe { wit_import0(_rt::as_i32(&features), _rt::as_f32(&scale), _rt::as_i32(&levels), _rt::as_i32(&edge_threshold), _rt::as_i32(&first), _rt::as_i32(&wtak), score_type.clone() as i32, _rt::as_i32(&patch_size), _rt::as_i32(&fast_threshold)) };
            unsafe { OrbDetector::from_handle(ret as u32) }
          }
        }
      }
      ...
      impl SiftDetector {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe extern "C" fn wit_import1(_: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import1(ptr0.cast_mut(), len0) };
            unsafe { SiftDetector::from_handle(ret as u32) }
          }
        }
      }
      impl SiftDetector {
      ...
      impl BfMatcher {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe extern "C" fn wit_import1(_: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import1(ptr0.cast_mut(), len0) };
            unsafe { BfMatcher::from_handle(ret as u32) }
          }
        }
      }
      impl BfMatcher {
        ...
        pub fn new_with_params(norm: NormType,cross_check: bool,) -> BfMatcher{
          unsafe {
            ...
            let ret = unsafe { wit_import0(norm.clone() as i32, match &cross_check { true => 1, false => 0 }) };
            unsafe { BfMatcher::from_handle(ret as u32) }
          }
        }
      }
      ...
      impl BfMatcher {
        ...
        pub fn match_(&self,query: Mat,train: Mat,) -> Result<_rt::Vec::<DMatch>,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&query).take_handle() as i32, (&train).take_handle() as i32, ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result9 = match l2 {
              0 => {
                let e = {
      ...
      impl BfMatcher {
        ...
        pub fn knn_match(&self,query: Mat,train: Mat,k: u32,) -> Result<_rt::Vec::<_rt::Vec::<DMatch>>,ErrorResult>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import1(_: i32, _: i32, _: i32, _: i32, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import1((self).handle() as i32, (&query).take_handle() as i32, (&train).take_handle() as i32, _rt::as_i32(&k), ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result12 = match l2 {
              0 => {
                let e = {
      ...
      impl FlannBasedMatcher {
        ...
        pub fn new(name: &str,) -> Self{
          unsafe {
            ...
            unsafe extern "C" fn wit_import1(_: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import1(ptr0.cast_mut(), len0) };
            unsafe { FlannBasedMatcher::from_handle(ret as u32) }
          }
        }
      }
      impl FlannBasedMatcher {
  ...
  pub mod wasm {
    pub mod cv {
      ...
      pub mod request {
        ...
        _rt::run_ctors_once();let result0 = T::process(unsafe { super::super::super::super::wasm::cv::mat::Mat::from_handle(arg0 as u32) });
