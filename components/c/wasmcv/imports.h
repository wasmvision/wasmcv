...
typedef imports_string_t wasm_cv_types_error_result_t;
...
typedef wasm_cv_types_error_result_t wasm_cv_mat_error_result_t;
...
typedef struct {
  bool is_err;
  union {
    wasm_cv_mat_own_mat_t ok;
    wasm_cv_mat_error_result_t err;
  } val;
} wasm_cv_mat_result_own_mat_error_result_t;
...
typedef struct {
  bool is_err;
  union {
    wasm_cv_mat_mix_max_loc_result_t ok;
    wasm_cv_mat_error_result_t err;
  } val;
} wasm_cv_mat_result_mix_max_loc_result_error_result_t;
...
typedef wasm_cv_types_error_result_t wasm_cv_cv_error_result_t;
...
} wasm_cv_cv_result_void_error_result_t;
...
typedef struct {
  ...
  union {
    imports_string_t ok;
    wasm_cv_dnn_error_result_t err;
  } val;
} wasm_cv_dnn_result_string_error_result_t;

typedef struct {
  bool is_err;
  union {
    wasm_cv_dnn_own_net_t ok;
    wasm_cv_dnn_error_result_t err;
  } val;
} wasm_cv_dnn_result_own_net_error_result_t;
...
} wasm_cv_dnn_result_void_error_result_t;

typedef struct {
  bool is_err;
  union {
    wasm_cv_dnn_own_mat_t ok;
    wasm_cv_dnn_error_result_t err;
  } val;
} wasm_cv_dnn_result_own_mat_error_result_t;
...
typedef struct {
  bool is_err;
  union {
    wasm_cv_dnn_list_own_mat_t ok;
    wasm_cv_dnn_error_result_t err;
  } val;
} wasm_cv_dnn_result_list_own_mat_error_result_t;

typedef struct {
  bool is_err;
  union {
    imports_list_u32_t ok;
    wasm_cv_dnn_error_result_t err;
  } val;
} wasm_cv_dnn_result_list_u32_error_result_t;
...
} wasm_cv_dnn_result_list_string_error_result_t;

typedef struct {
  bool is_err;
  union {
    wasm_cv_dnn_own_layer_t ok;
    wasm_cv_dnn_error_result_t err;
  } val;
} wasm_cv_dnn_result_own_layer_error_result_t;
...
typedef struct {
  bool is_err;
  union {
    wasm_cv_dnn_list_rect_t ok;
    wasm_cv_dnn_error_result_t err;
  } val;
} wasm_cv_dnn_result_list_rect_error_result_t;

typedef wasm_cv_types_error_result_t wasm_cv_objdetect_error_result_t;
...
typedef struct {
  bool is_err;
  union {
    wasm_cv_objdetect_list_rect_t ok;
    wasm_cv_objdetect_error_result_t err;
  } val;
} wasm_cv_objdetect_result_list_rect_error_result_t;

typedef struct {
  bool is_err;
  union {
    wasm_cv_objdetect_own_mat_t ok;
    wasm_cv_objdetect_error_result_t err;
  } val;
} wasm_cv_objdetect_result_own_mat_error_result_t;
...
} wasm_cv_objdetect_result_f32_error_result_t;

typedef wasm_cv_types_error_result_t wasm_cv_features2d_error_result_t;
...
typedef struct {
  bool is_err;
  union {
    wasm_cv_features2d_list_key_point_t ok;
    wasm_cv_features2d_error_result_t err;
  } val;
} wasm_cv_features2d_result_list_key_point_error_result_t;

typedef struct {
  bool is_err;
  union {
    wasm_cv_features2d_detector_result_t ok;
    wasm_cv_features2d_error_result_t err;
  } val;
} wasm_cv_features2d_result_detector_result_error_result_t;
...
typedef struct {
  bool is_err;
  union {
    wasm_cv_features2d_list_d_match_t ok;
    wasm_cv_features2d_error_result_t err;
  } val;
} wasm_cv_features2d_result_list_d_match_error_result_t;
...
typedef struct {
  bool is_err;
  union {
    wasm_cv_features2d_list_list_d_match_t ok;
    wasm_cv_features2d_error_result_t err;
  } val;
} wasm_cv_features2d_result_list_list_d_match_error_result_t;
...
extern bool wasm_cv_mat_method_mat_reshape(wasm_cv_mat_borrow_mat_t self, uint32_t channels, uint32_t rows, wasm_cv_mat_own_mat_t *ret, wasm_cv_mat_error_result_t *err);
...
extern bool wasm_cv_mat_method_mat_row_range(wasm_cv_mat_borrow_mat_t self, uint32_t start, uint32_t end, wasm_cv_mat_own_mat_t *ret, wasm_cv_mat_error_result_t *err);
...
extern bool wasm_cv_mat_method_mat_col_range(wasm_cv_mat_borrow_mat_t self, uint32_t start, uint32_t end, wasm_cv_mat_own_mat_t *ret, wasm_cv_mat_error_result_t *err);
// MinMaxLoc finds the global minimum and maximum in an array.
// 
// For further details, please see:
// https://docs.opencv.org/trunk/d2/de8/group__core__array.html#gab473bf2eb6d14ff97e89b355dac20707
extern bool wasm_cv_mat_method_mat_min_max_loc(wasm_cv_mat_borrow_mat_t self, wasm_cv_mat_mix_max_loc_result_t *ret, wasm_cv_mat_error_result_t *err);
...
extern bool wasm_cv_mat_method_mat_col(wasm_cv_mat_borrow_mat_t self, uint32_t col, wasm_cv_mat_own_mat_t *ret, wasm_cv_mat_error_result_t *err);
// row creates a matrix header for the specified matrix row.
// The underlying data of the new matrix is shared with the original matrix.
extern bool wasm_cv_mat_method_mat_row(wasm_cv_mat_borrow_mat_t self, uint32_t row, wasm_cv_mat_own_mat_t *ret, wasm_cv_mat_error_result_t *err);
...
extern bool wasm_cv_cv_arrowed_line(wasm_cv_cv_borrow_mat_t img, wasm_cv_cv_point_t *point1, wasm_cv_cv_point_t *point2, wasm_cv_cv_rgba_t *c, uint8_t thickness, wasm_cv_cv_error_result_t *err);
// Rectangle draws a simple, thick, or filled up-right rectangle.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d6/d6e/group__imgproc__draw.html#ga07d2f74cadcf8e305e810ce8f3d1e1b7
extern bool wasm_cv_cv_rectangle(wasm_cv_cv_borrow_mat_t img, wasm_cv_cv_rect_t *r, wasm_cv_cv_rgba_t *c, uint8_t thickness, wasm_cv_cv_error_result_t *err);
// Circle draws a circle.
// 
// For further details, please see:
// https://docs.opencv.org/master/d6/d6e/group__imgproc__draw.html#gaf10604b069374903dbd0f0488cb43670
extern bool wasm_cv_cv_circle(wasm_cv_cv_borrow_mat_t img, wasm_cv_cv_point_t *center, uint32_t radius, wasm_cv_cv_rgba_t *c, uint8_t thickness, wasm_cv_cv_error_result_t *err);
// Line draws a line segment connecting two points.
// 
// For further details, please see:
// https://docs.opencv.org/master/d6/d6e/group__imgproc__draw.html#ga7078a9fae8c7e7d13d24dac2520ae4a2
extern bool wasm_cv_cv_line(wasm_cv_cv_borrow_mat_t img, wasm_cv_cv_point_t *point1, wasm_cv_cv_point_t *point2, wasm_cv_cv_rgba_t *c, uint8_t thickness, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_put_text(wasm_cv_cv_borrow_mat_t img, imports_string_t *text, wasm_cv_cv_point_t *org, wasm_cv_cv_hershey_font_type_t font_face, double font_scale, wasm_cv_cv_rgba_t *c, int32_t thickness, wasm_cv_cv_error_result_t *err);
// imgproc functions
// AdaptiveThreshold applies a fixed-level threshold to each array element.
// 
// For further details, please see:
// https://docs.opencv.org/master/d7/d1b/group__imgproc__misc.html#ga72b913f352e4a1b1b397736707afcde3
extern bool wasm_cv_cv_adaptive_threshold(wasm_cv_cv_own_mat_t src, float max_value, wasm_cv_cv_adaptive_threshold_type_t adaptive_type, wasm_cv_cv_threshold_type_t threshold_type, uint32_t block_size, float c, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// Blur blurs an image Mat using a normalized box filter.
// 
// For further details, please see:
// https://docs.opencv.org/master/d4/d86/group__imgproc__filter.html#ga8c45db9afe636703801b0b2e440fce37
extern bool wasm_cv_cv_blur(wasm_cv_cv_own_mat_t src, wasm_cv_cv_size_t *k_size, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// BoxFilter blurs an image using the box filter.
// 
// For further details, please see:
// https://docs.opencv.org/master/d4/d86/group__imgproc__filter.html#gad533230ebf2d42509547d514f7d3fbc3
extern bool wasm_cv_cv_box_filter(wasm_cv_cv_own_mat_t src, uint32_t depth, wasm_cv_cv_size_t *k_size, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_canny(wasm_cv_cv_own_mat_t src, float threshold1, float threshold2, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// CvtColor converts an image from one color space to another.
// 
// For further details, please see:
// http://docs.opencv.org/master/d7/d1b/group__imgproc__misc.html#ga4e0972be5de079fed4e3a10e24ef5ef0
extern bool wasm_cv_cv_cvt_color(wasm_cv_cv_own_mat_t src, wasm_cv_cv_color_coversion_type_t code, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// Dilate dilates an image by using a specific structuring element.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d4/d86/group__imgproc__filter.html#ga4ff0f3318642c4f469d0e11f242f3b6c
extern bool wasm_cv_cv_dilate(wasm_cv_cv_own_mat_t src, wasm_cv_cv_own_mat_t kernel, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// Erode erodes an image by using a specific structuring element.
// 
// For further details, please see:
// https://docs.opencv.org/master/d4/d86/group__imgproc__filter.html#gaeb1e0c1033e3f6b891a25d0511362aeb
extern bool wasm_cv_cv_erode(wasm_cv_cv_own_mat_t src, wasm_cv_cv_own_mat_t kernel, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// EqualizeHist normalizes the brightness and increases the contrast of the image.
// 
// For further details, please see:
// https://docs.opencv.org/master/d6/dc7/group__imgproc__hist.html#ga7e54091f0c937d49bf84152a16f76d6e
extern bool wasm_cv_cv_equalize_hist(wasm_cv_cv_own_mat_t src, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// GaussianBlur blurs an image using a Gaussian filter.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d4/d86/group__imgproc__filter.html#gae8bdcd9154ed5ca3cbc1766d960f45c1
extern bool wasm_cv_cv_gaussian_blur(wasm_cv_cv_own_mat_t src, wasm_cv_cv_size_t *size, float sigma_x, float sigma_y, wasm_cv_cv_border_type_t border, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// GetStructuringElement returns a structuring element of the specified size
// and shape for morphological operations.
// 
// For further details, please see:
// https://docs.opencv.org/master/d4/d86/group__imgproc__filter.html#gac342a1bb6eabf6f55c803b09268e36dc
extern bool wasm_cv_cv_get_structuring_element(wasm_cv_cv_morph_shape_t shape, wasm_cv_cv_size_t *size, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_hough_lines(wasm_cv_cv_own_mat_t src, double rho, double theta, int32_t threshold, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_hough_lines_p(wasm_cv_cv_own_mat_t src, double rho, double theta, int32_t threshold, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// MedianBlur blurs an image using the median filter.
// 
// For further details, please see:
// https://docs.opencv.org/master/d4/d86/group__imgproc__filter.html#ga564869aa33e58769b4469101aac458f9
extern bool wasm_cv_cv_median_blur(wasm_cv_cv_own_mat_t src, wasm_cv_cv_size_t *k_size, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_resize(wasm_cv_cv_own_mat_t src, wasm_cv_cv_size_t *size, float fx, float fy, wasm_cv_cv_interpolation_type_t interp, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// Threshold applies a fixed-level threshold to each array element.
// 
// For further details, please see:
// https://docs.opencv.org/3.3.0/d7/d1b/group__imgproc__misc.html#gae8a4a146d1ca78c626a53577199e9c57
extern bool wasm_cv_cv_threshold(wasm_cv_cv_own_mat_t src, float thresh, float max_value, wasm_cv_cv_threshold_type_t threshold_type, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// Transpose for n-dimensional matrices.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d2/de8/group__core__array.html#gab1b1274b4a563be34cdfa55b8919a4ec
extern bool wasm_cv_cv_transpose_nd(wasm_cv_cv_own_mat_t src, imports_list_s32_t *order, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_estimate_affine2d(wasm_cv_cv_own_mat_t frm, wasm_cv_cv_own_mat_t to, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_warp_affine(wasm_cv_cv_own_mat_t src, wasm_cv_cv_own_mat_t m, wasm_cv_cv_size_t *size, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_get_rotation_matrix2d(wasm_cv_cv_point_t *center, double angle, double scale, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_add(wasm_cv_cv_own_mat_t src1, wasm_cv_cv_own_mat_t src2, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
extern bool wasm_cv_cv_exp(wasm_cv_cv_own_mat_t src, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// hconcat applies horizontal concatenation to given matrices.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d2/de8/group__core__array.html#gaab5ceee39e0580f879df645a872c6bf7
extern bool wasm_cv_cv_hconcat(wasm_cv_cv_own_mat_t src1, wasm_cv_cv_own_mat_t src2, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
// vconcat applies vertical concatenation to given matrices.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d2/de8/group__core__array.html#ga744f53b69f6e4f12156cdde4e76aed27
extern bool wasm_cv_cv_vconcat(wasm_cv_cv_own_mat_t src1, wasm_cv_cv_own_mat_t src2, wasm_cv_cv_own_mat_t *ret, wasm_cv_cv_error_result_t *err);
...
// Close the layer
extern void wasm_cv_dnn_method_layer_close(wasm_cv_dnn_borrow_layer_t self);
// GetName returns the name of the layer.
extern bool wasm_cv_dnn_method_layer_get_name(wasm_cv_dnn_borrow_layer_t self, imports_string_t *ret, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_dnn_static_net_read(imports_string_t *model, imports_string_t *config, wasm_cv_dnn_own_net_t *ret, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_dnn_static_net_read_from_onnx(imports_string_t *model, wasm_cv_dnn_own_net_t *ret, wasm_cv_dnn_error_result_t *err);
// Close the network
...
extern bool wasm_cv_dnn_method_net_set_input(wasm_cv_dnn_borrow_net_t self, wasm_cv_dnn_own_mat_t input, imports_string_t *name, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_dnn_method_net_forward(wasm_cv_dnn_borrow_net_t self, imports_string_t *output_name, wasm_cv_dnn_own_mat_t *ret, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_dnn_method_net_forward_layers(wasm_cv_dnn_borrow_net_t self, imports_list_string_t *output_names, wasm_cv_dnn_list_own_mat_t *ret, wasm_cv_dnn_error_result_t *err);
// GetUnconnectedOutLayers returns indexes of layers with unconnected outputs.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/db/d30/classcv_1_1dnn_1_1Net.html#ae26f0c29b3733d15d0482098ef9053e3
extern bool wasm_cv_dnn_method_net_get_unconnected_out_layers(wasm_cv_dnn_borrow_net_t self, imports_list_u32_t *ret, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_dnn_method_net_get_layer_names(wasm_cv_dnn_borrow_net_t self, imports_list_string_t *ret, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_dnn_method_net_get_layer(wasm_cv_dnn_borrow_net_t self, uint32_t id, wasm_cv_dnn_own_layer_t *ret, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_dnn_blob_from_image(wasm_cv_dnn_own_mat_t image, float scale_factor, wasm_cv_dnn_size_t *size, wasm_cv_dnn_scalar_t *mean, bool swap_rb, bool crop, wasm_cv_dnn_own_mat_t *ret, wasm_cv_dnn_error_result_t *err);
// BlobFromImageWithParams creates 4-dimensional blob from image. Optionally resizes and crops image from center,
// subtract mean values, scales values by scalefactor, swap Blue and Red channels.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d6/d0f/group__dnn.html#ga29f34df9376379a603acd8df581ac8d7
extern bool wasm_cv_dnn_blob_from_image_with_params(wasm_cv_dnn_own_mat_t image, wasm_cv_dnn_blob_params_t *params, wasm_cv_dnn_own_mat_t *ret, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_dnn_blob_rects_to_image_rects(wasm_cv_dnn_blob_params_t *params, wasm_cv_dnn_list_rect_t *blob_rects, wasm_cv_dnn_size_t *image_size, wasm_cv_dnn_list_rect_t *ret, wasm_cv_dnn_error_result_t *err);
// NMSBoxes performs non maximum suppression given boxes and corresponding scores.
// 
// For futher details, please see:
// https://docs.opencv.org/4.4.0/d6/d0f/group__dnn.html#ga9d118d70a1659af729d01b10233213ee
extern bool wasm_cv_dnn_nms_boxes(wasm_cv_dnn_list_rect_t *bboxes, imports_list_f32_t *scores, float score_threshold, float nms_threshold, imports_list_u32_t *ret, wasm_cv_dnn_error_result_t *err);
...
extern bool wasm_cv_objdetect_method_hog_descriptor_detect_multi_scale(wasm_cv_objdetect_borrow_hog_descriptor_t self, wasm_cv_objdetect_own_mat_t image, wasm_cv_objdetect_list_rect_t *ret, wasm_cv_objdetect_error_result_t *err);
// DetectMultiScaleWithParams detects objects of different sizes in the input Mat image.
// The detected objects are returned as a slice of image.Rectangle structs.
// 
// For further details, please see:
// https://docs.opencv.org/master/d5/d33/structcv_1_1HOGDescriptor.html#a660e5cd036fd5ddf0f5767b352acd948
extern bool wasm_cv_objdetect_method_hog_descriptor_detect_multi_scale_with_params(wasm_cv_objdetect_borrow_hog_descriptor_t self, wasm_cv_objdetect_own_mat_t image, double hit_threshold, wasm_cv_objdetect_size_t *win_stride, wasm_cv_objdetect_size_t *padding, double scale, double final_threshold, bool use_meanshift_grouping, wasm_cv_objdetect_list_rect_t *ret, wasm_cv_objdetect_error_result_t *err);
...
extern bool wasm_cv_objdetect_method_face_detector_yn_detect(wasm_cv_objdetect_borrow_face_detector_yn_t self, wasm_cv_objdetect_own_mat_t input, wasm_cv_objdetect_own_mat_t *ret, wasm_cv_objdetect_error_result_t *err);
...
extern bool wasm_cv_objdetect_method_face_recognizer_sf_align_crop(wasm_cv_objdetect_borrow_face_recognizer_sf_t self, wasm_cv_objdetect_own_mat_t src, wasm_cv_objdetect_own_mat_t face_box, wasm_cv_objdetect_own_mat_t *ret, wasm_cv_objdetect_error_result_t *err);
...
extern bool wasm_cv_objdetect_method_face_recognizer_sf_feature(wasm_cv_objdetect_borrow_face_recognizer_sf_t self, wasm_cv_objdetect_own_mat_t aligned, wasm_cv_objdetect_own_mat_t *ret, wasm_cv_objdetect_error_result_t *err);
...
extern bool wasm_cv_objdetect_method_face_recognizer_sf_match(wasm_cv_objdetect_borrow_face_recognizer_sf_t self, wasm_cv_objdetect_own_mat_t face1, wasm_cv_objdetect_own_mat_t face2, float *ret, wasm_cv_objdetect_error_result_t *err);
// Match calculates the distance between two face features.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/da/d09/classcv_1_1FaceRecognizerSF.html#a2f0362ca1e64320a1f3ba7e1386d0219
extern bool wasm_cv_objdetect_method_face_recognizer_sf_match_with_params(wasm_cv_objdetect_borrow_face_recognizer_sf_t self, wasm_cv_objdetect_own_mat_t face1, wasm_cv_objdetect_own_mat_t face2, wasm_cv_objdetect_face_distance_type_t distance, float *ret, wasm_cv_objdetect_error_result_t *err);
...
extern bool wasm_cv_features2d_method_akaze_detector_detect(wasm_cv_features2d_borrow_akaze_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_list_key_point_t *ret, wasm_cv_features2d_error_result_t *err);
...
extern bool wasm_cv_features2d_method_akaze_detector_compute(wasm_cv_features2d_borrow_akaze_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_list_key_point_t *kps, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
// DetectAndCompute keypoints and compute in an image using AKAZE.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#a8be0d1c20b08eb867184b8d74c15a677
extern bool wasm_cv_features2d_method_akaze_detector_detect_and_compute(wasm_cv_features2d_borrow_akaze_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
...
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#aa4e9a7082ec61ebc108806704fbd7887
extern bool wasm_cv_features2d_method_brisk_detector_detect(wasm_cv_features2d_borrow_brisk_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_list_key_point_t *ret, wasm_cv_features2d_error_result_t *err);
// Compute keypoints in an image using BRISK.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#ab3cce8d56f4fc5e1d530b5931e1e8dc0
extern bool wasm_cv_features2d_method_brisk_detector_compute(wasm_cv_features2d_borrow_brisk_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_list_key_point_t *kps, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
// DetectAndCompute keypoints and compute in an image using BRISK.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#a8be0d1c20b08eb867184b8d74c15a677
extern bool wasm_cv_features2d_method_brisk_detector_detect_and_compute(wasm_cv_features2d_borrow_brisk_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
...
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#aa4e9a7082ec61ebc108806704fbd7887
extern bool wasm_cv_features2d_method_kaze_detector_detect(wasm_cv_features2d_borrow_kaze_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_list_key_point_t *ret, wasm_cv_features2d_error_result_t *err);
// Compute keypoints in an image using KAZE.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#ab3cce8d56f4fc5e1d530b5931e1e8dc0
extern bool wasm_cv_features2d_method_kaze_detector_compute(wasm_cv_features2d_borrow_kaze_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_list_key_point_t *kps, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
// DetectAndCompute keypoints and compute in an image using KAZE.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#a8be0d1c20b08eb867184b8d74c15a677
extern bool wasm_cv_features2d_method_kaze_detector_detect_and_compute(wasm_cv_features2d_borrow_kaze_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
...
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#aa4e9a7082ec61ebc108806704fbd7887
extern bool wasm_cv_features2d_method_orb_detector_detect(wasm_cv_features2d_borrow_orb_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_list_key_point_t *ret, wasm_cv_features2d_error_result_t *err);
// Compute keypoints in an image using ORB.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#ab3cce8d56f4fc5e1d530b5931e1e8dc0
extern bool wasm_cv_features2d_method_orb_detector_compute(wasm_cv_features2d_borrow_orb_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_list_key_point_t *kps, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
// DetectAndCompute keypoints and compute in an image using ORB.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#a8be0d1c20b08eb867184b8d74c15a677
extern bool wasm_cv_features2d_method_orb_detector_detect_and_compute(wasm_cv_features2d_borrow_orb_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
...
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#aa4e9a7082ec61ebc108806704fbd7887
extern bool wasm_cv_features2d_method_sift_detector_detect(wasm_cv_features2d_borrow_sift_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_list_key_point_t *ret, wasm_cv_features2d_error_result_t *err);
// Compute keypoints in an image using SIFT.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#ab3cce8d56f4fc5e1d530b5931e1e8dc0
extern bool wasm_cv_features2d_method_sift_detector_compute(wasm_cv_features2d_borrow_sift_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_list_key_point_t *kps, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
// DetectAndCompute keypoints and compute in an image using SIFT.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/d0/d13/classcv_1_1Feature2D.html#a8be0d1c20b08eb867184b8d74c15a677
extern bool wasm_cv_features2d_method_sift_detector_detect_and_compute(wasm_cv_features2d_borrow_sift_detector_t self, wasm_cv_features2d_own_mat_t src, wasm_cv_features2d_own_mat_t mask, wasm_cv_features2d_detector_result_t *ret, wasm_cv_features2d_error_result_t *err);
...
extern bool wasm_cv_features2d_method_bf_matcher_match(wasm_cv_features2d_borrow_bf_matcher_t self, wasm_cv_features2d_own_mat_t query, wasm_cv_features2d_own_mat_t train, wasm_cv_features2d_list_d_match_t *ret, wasm_cv_features2d_error_result_t *err);
// KNNMatch finds the k best matches for each descriptor from a query set.
// 
// For further details, please see:
// https://docs.opencv.org/4.x/db/d39/classcv_1_1DescriptorMatcher.html#aa880f9353cdf185ccf3013e08210483a
extern bool wasm_cv_features2d_method_bf_matcher_knn_match(wasm_cv_features2d_borrow_bf_matcher_t self, wasm_cv_features2d_own_mat_t query, wasm_cv_features2d_own_mat_t train, uint32_t k, wasm_cv_features2d_list_list_d_match_t *ret, wasm_cv_features2d_error_result_t *err);
...
// For further details, please see:
// https://docs.opencv.org/4.x/db/d39/classcv_1_1DescriptorMatcher.html#aa880f9353cdf185ccf3013e08210483a
extern bool wasm_cv_features2d_method_flann_based_matcher_knn_match(wasm_cv_features2d_borrow_flann_based_matcher_t self, wasm_cv_features2d_own_mat_t query, wasm_cv_features2d_own_mat_t train, uint32_t k, wasm_cv_features2d_list_list_d_match_t *ret, wasm_cv_features2d_error_result_t *err);
...
extern void wasm_cv_mat_mat_drop_borrow(wasm_cv_mat_borrow_mat_t handle);
...
extern void wasm_cv_dnn_layer_drop_borrow(wasm_cv_dnn_borrow_layer_t handle);
...
extern void wasm_cv_dnn_net_drop_borrow(wasm_cv_dnn_borrow_net_t handle);
...
extern void wasm_cv_objdetect_cascade_classifier_drop_borrow(wasm_cv_objdetect_borrow_cascade_classifier_t handle);
...
extern void wasm_cv_objdetect_hog_descriptor_drop_borrow(wasm_cv_objdetect_borrow_hog_descriptor_t handle);
...
extern void wasm_cv_objdetect_face_detector_yn_drop_borrow(wasm_cv_objdetect_borrow_face_detector_yn_t handle);
...
extern void wasm_cv_objdetect_face_recognizer_sf_drop_borrow(wasm_cv_objdetect_borrow_face_recognizer_sf_t handle);
...
extern void wasm_cv_features2d_akaze_detector_drop_borrow(wasm_cv_features2d_borrow_akaze_detector_t handle);
...
extern void wasm_cv_features2d_brisk_detector_drop_borrow(wasm_cv_features2d_borrow_brisk_detector_t handle);
...
extern void wasm_cv_features2d_kaze_detector_drop_borrow(wasm_cv_features2d_borrow_kaze_detector_t handle);
...
extern void wasm_cv_features2d_orb_detector_drop_borrow(wasm_cv_features2d_borrow_orb_detector_t handle);
...
extern void wasm_cv_features2d_sift_detector_drop_borrow(wasm_cv_features2d_borrow_sift_detector_t handle);
...
extern void wasm_cv_features2d_bf_matcher_drop_borrow(wasm_cv_features2d_borrow_bf_matcher_t handle);
...
extern void wasm_cv_features2d_flann_based_matcher_drop_borrow(wasm_cv_features2d_borrow_flann_based_matcher_t handle);
